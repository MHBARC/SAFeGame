...
const questions = [
    ...
    answer: "<div style='display:flex;flex-wrap:wrap;justify-content:center;gap:15px;'><div style='background:#f8e9eb;padding:10px;border-radius:5px;'><strong>Alignment</strong></div><div style='background:#f8e9eb;padding:10px;border-radius:5px;'><strong>Transparency</strong></div><div style='background:#f8e9eb;padding:10px;border-radius:5px;'><strong>Respect for People</strong></div><div style='background:#f8e9eb;padding:10px;border-radius:5px;'><strong>Relentless Improvement</strong></div></div><br>Learn more: <a href='https://www.scaledagileframework.com/safe-core-values/' target='_blank'>SAFe Core Values</a>",
    difficulty: "Easy",
    type: "standard"
    },
    {
